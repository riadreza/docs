...
services:
  geoip-updater:
    ...
    environment:
      - GEOIPUPDATE_ACCOUNT_ID=1285047
      - GEOIPUPDATE_LICENSE_KEY=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
  ...
  goaccess-engine:
    ...
    command: >
      ...
      --addr=0.0.0.0
      --port=7890
      --ws-url=wss://stats.palonet.org:443/ws
      --geoip-database=/geoip/GeoLite2-City.mmdb
      -d
      --double-decode
      # Hide your own domain so you see real referrers
      --hide-referer=palonet.org
      --hide-referer=container.palonet.org
      --hide-referer=stats.palonet.org
    deploy:
