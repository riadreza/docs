...
* i<Icon name="rocket" /> IT infrastructure and system architecture
* i<Icon name="shield" /> Networking and network security
* i<Icon name="server" /> Linux and system administration
* i<Icon name="cloud" /> Cloud and container-based platforms
* i<Icon name="eye" /> Monitoring, logging, and observability
* i<Icon name="hard-hat" /> Backup, disaster recovery, and operations
