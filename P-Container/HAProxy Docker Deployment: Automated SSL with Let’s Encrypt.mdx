...
a. Open your web browser and navigate to `http://your-server-ip:8080/stats`.
b. You should see the HAProxy statistics dashboard. Log in using the credentials specified in the `haproxy.cfg` file (username: admin, password: XXXXXXXX).
## Conclusion   
