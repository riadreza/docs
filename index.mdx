...
* icon="rocket" IT infrastructure and system architecture
* icon="shield" Networking and network security
* icon="server" Linux and system administration
* icon="cloud" Cloud and container-based platforms
* icon="eye" Monitoring, logging, and observability
* icon="hard-hat" Backup, disaster recovery, and operations
