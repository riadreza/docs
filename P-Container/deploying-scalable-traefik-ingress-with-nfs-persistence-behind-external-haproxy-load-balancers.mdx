...
Refer to the [Setting Up an NFS Server for Persistent Storage](./complete-ubuntu-vm-setup-with-lvm-storage-and-nfs-shares.mdxsetting-up-nfs-server-for-persistent-storage) guide for instructions on configuring an NFS server.
